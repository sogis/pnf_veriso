...
class ExportDefects(QObject):
    ...
    def run(self):
        ...
        try:
            ...
            worksheet_points.write_string(4, i + 1,
                                   tr("Y-Koordinate", self.tr_tag, None),
                                   fmt_italic)
            worksheet_points.write_string(4, i + 2,
            ...
            for feat in iterator:
                ...
                worksheet_points.write_number(5 + j, k + 1, point.y(), fmt_3dec)
                j += 1
            ...
            # Write project name into worksheet.
            worksheet_lines.write_string(0, 0,
                                  tr("Operat: ", self.tr_tag,
                                     None), fmt_bold)
            ...
            #            types = []
            for i in range(len(attrs)):
                worksheet_lines.write_string(4, i, str(attrs.at(i).name()), fmt_italic)
            # types.append(attrs.at(i).type())
            ...
            for feat in iterator:
                ...
                worksheet_lines.write_number(5 + j, k + 2, geom.length(), fmt_2dec)
                j += 1
