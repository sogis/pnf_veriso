...
class ComplexCheck(ComplexCheckBase):
    ...
    def run(self):
        ...
        try:
            group = _translate("VeriSO_PNF_Strasse", "Lagekontrolle - Strasse", None)
            ...
            layer = {
                "type": "postgres",
                "title": _translate("VeriSO_PNF_Strasse", "Gemeindegrenze",
                                    None),
            ...
            layer = {
                ...
                "geom": "geometrie", "key": "ogc_fid", "sql": "",
                "readonly": True, "group": group,
                "style": "bb/bb_strasse_ortho_massstab.qml"
            }
            vlayer = self.layer_loader.load(layer, True, False)
            ...
            layer = {
                "type": "postgres",
                "title": _translate("VeriSO_PNF_Strasse", "EO.Punktelement",
                                    None),
            ...
            layer = {
                "type": "postgres",
                "title": _translate("VeriSO_PNF_Strasse", "GEB.Strassenstueck",
                                    None),
                "featuretype": "gebaeudeadressen_strassenstueck",
                "geom": "geometrie", "key": "ogc_fid", "sql": "",
                "readonly": True, "group": group,
                "style": "geb/strassenstueck.qml"
            }
            vlayer = self.layer_loader.load(layer, True, False)
            ...
            layer = {
                "type": "postgres",
                "title": _translate("VeriSO_PNF_Strasse", "TS-Einteilung",
                                    None),
            ...
            layer = {
                "type": "postgres",
                "title": _translate("VeriSO_PNF_Strasse", "Kontrollraster (Planeinteilung)",
                                    None),
                "featuretype": "t_kontrollraster_plan_strasse",
            ...
            layer = {
                "type": "postgres",
                "title": _translate("VeriSO_PNF_Strasse", "Kontrollraster",
                                    None),
