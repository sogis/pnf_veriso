...
class ComplexCheck(ComplexCheckBase):
    ...
    def run(self):
        ...
        try:
            group = _translate("VeriSO_PNF_Seltene_Objekte", "Maengel - Seltene Objekte" , None)
            group += " (" + str(project_id) + ")"

            layer = {
                "type": "postgres",
                "title": _translate("VeriSO_PNF_Seltene_Objekte", "Fehlerarten",
                                    None),
            ...
            layer = {
                "type": "postgres", "title": _translate("VeriSO_PNF_Seltene_Objekte",
                                                        "Maengelarten",
                                                        None),
                "featuretype": "t_maengel_art",
                "geom": "", "key": "ogc_fid",
                "sql": "gruppe = 'Seltene Objekte'", "readonly": True,
                "group": group
            }
            ...
            layer = {
                ...
                "sql": "gruppe = 'Seltene Objekte'", "readonly": False,
