...
class ComplexCheck(ComplexCheckBase):
    ...
    def run(self):
        ...
        try:
            group = _translate("VeriSO_PNF_Gewaesser", "Maengel - Gewaesser", None)
            group += " (" + str(project_id) + ")"

            layer = {
                "type": "postgres",
                "title": _translate("VeriSO_PNF_Gewaesser", "Fehlerarten",
                                    None),
            ...
            layer = {
                "type": "postgres", "title": _translate("VeriSO_PNF_Gewaesser",
                                                        "Maengelarten",
                                                        None),
                "featuretype": "t_maengel_art",
                "geom": "", "key": "ogc_fid",
                "sql": "gruppe = 'Gewaesser'", "readonly": True,
                "group": group
            }
            ...
            layer = {
                ...
                "sql": "gruppe = 'Gewaesser'", "readonly": False,
