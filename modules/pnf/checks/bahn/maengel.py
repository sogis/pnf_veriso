...
class ComplexCheck(ComplexCheckBase):
    ...
    def run(self):
        ...
        try:
            group = _translate("VeriSO_PNF_Bahn", "Maengel - Bahn", None)
            group += " (" + str(project_id) + ")"

            layer = {
                "type": "postgres",
                "title": _translate("VeriSO_PNF_Bahn", "Fehlerarten",
                                    None),
            ...
            layer = {
                "type": "postgres", "title": _translate("VeriSO_PNF_Bahn",
                                                        "Maengelarten",
                                                        None),
                "featuretype": "t_maengel_art",
                "geom": "", "key": "ogc_fid",
                "sql": "gruppe = 'Bahn'", "readonly": True,
                "group": group
            }
            ...
            layer = {
                ...
                "sql": "gruppe = 'Bahn'", "readonly": False,
