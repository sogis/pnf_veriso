...
class ComplexCheck(ComplexCheckBase):
    ...
    def run(self):
        ...
        try:
            group = _translate("VeriSO_PNF_Landwirtschaft", "Maengel - Landwirtschaft" , None)
            group += " (" + str(project_id) + ")"

            layer = {
                "type": "postgres",
                "title": _translate("VeriSO_PNF_Landwirtschaft", "Fehlerarten",
                                    None),
            ...
            layer = {
                "type": "postgres", "title": _translate("VeriSO_PNF_Landwirtschaft",
                                                        "Maengelarten",
                                                        None),
                "featuretype": "t_maengel_art",
                "geom": "", "key": "ogc_fid",
                "sql": "gruppe = 'Landwirtschaft'", "readonly": True,
                "group": group
            }
            ...
            layer = {
                ...
                "sql": "gruppe = 'Landwirtschaft'", "readonly": False,
