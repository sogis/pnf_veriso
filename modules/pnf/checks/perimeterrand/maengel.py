    ...
    def run(self):
        ...
        if not project_id:
            self.message_bar.pushCritical("Error",
                                          _translate("VeriSO_PNF_Perimeterrand",
                                                     "project_id not set",
                                                     None))
            return
        ...
        try:
            group = _translate("VeriSO_PNF_Perimeterrand", "Maengel - Perimeterrand" , None)
            group += " (" + str(project_id) + ")"

            layer = {
                "type": "postgres",
                "title": _translate("VeriSO_PNF_Perimeterrand", "Fehlerarten",
                                    None),
            ...
            layer = {
                "type": "postgres", "title": _translate("VeriSO_PNF_Perimeterrand",
                                                        "Maengelarten",
                                                        None),
                "featuretype": "t_maengel_art",
                "geom": "", "key": "ogc_fid",
                "sql": "gruppe = 'Perimeterrand'", "readonly": True,
                "group": group
            }
            ...
            layer = {
                ...
                "sql": "gruppe = 'Perimeterrand'", "readonly": False,
