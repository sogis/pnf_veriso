...
<qgis version="1.9.0-Master" minimumScale="0" maximumScale="20000" hasScaleBasedVisibilityFlag="1">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter="&quot;EO.Einzelobjekt_art&quot;  = 27" symbol="0" label="Rinnsal"/>
      <rule filter="&quot;EO.Einzelobjekt_art&quot;  = 4" symbol="1" label="eingedoltes_oeffentliche_Gewaesser"/>
      <rule scalemaxdenom="5000" filter="&quot;EO.Einzelobjekt_art&quot;  NOT IN (27,4)" symbol="2" label="andere"/>
    </rules>
    <symbols>
      <symbol outputUnit="MM" alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="color" v="149,39,101,255"/>
