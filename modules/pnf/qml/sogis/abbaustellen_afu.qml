...
<qgis version="1.9.0-Master" minimumScale="-4.65661e-10" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol outputUnit="MM" alpha="0.529412" type="marker" name="0">
        ...
        <layer pass="0" class="FontMarker" locked="0">
          ...
          <prop k="offset" v="0.2,0"/>
          <prop k="size" v="8.23333"/>
        </layer>
      </symbol>
    </symbols>
    <rotation field=""/>
  ...
  <edittypes>
    <edittype type="0" name="aktiv"/>
    <edittype type="0" name="archive"/>
    <edittype type="0" name="archive_da"/>
    <edittype type="0" name="aufbereitu"/>
    <edittype type="0" name="aufnahmeda"/>
    <edittype type="0" name="bemerkung"/>
    <edittype type="0" name="beschreibu"/>
    <edittype type="0" name="bezeichnun"/>
    <edittype type="0" name="brauchrese"/>
    <edittype type="0" name="code"/>
    <edittype type="0" name="erfasser"/>
    <edittype type="0" name="gid"/>
    <edittype type="0" name="loeschrese"/>
    <edittype type="0" name="mobj_id"/>
    <edittype type="0" name="name"/>
    <edittype type="0" name="new_date"/>
    <edittype type="0" name="o_art"/>
    <edittype type="0" name="objekttyp_"/>
    <edittype type="0" name="ogc_fid"/>
    <edittype type="0" name="url"/>
    <edittype type="0" name="vegas_id"/>
    <edittype type="0" name="verwendung"/>
    <edittype type="0" name="wspg"/>
  </edittypes>
  <editform></editform>
