...
<qgis version="1.9.0-Master" minimumScale="-4.65661e-10" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol outputUnit="MM" alpha="0.788235" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="color" v="255,126,61,255"/>
          <prop k="color_border" v="255,126,61,255"/>
          <prop k="offset" v="0,0"/>
  ...
  <edittypes>
    ...
    <edittype type="0" name="HM_"/>
    <edittype type="0" name="HM_FL"/>
    <edittype type="0" name="HM_GF"/>
    <edittype type="0" name="HM_ID"/>
    <edittype type="0" name="HM_KE"/>
    <edittype type="0" name="HM_NAME"/>
    <edittype type="0" name="HM_OBJ"/>
    <edittype type="0" name="HM_TO"/>
    <edittype type="0" name="HM_TYP"/>
    <edittype type="0" name="HM_VERSION"/>
    <edittype type="0" name="PERIMETER"/>
    <edittype type="0" name="__gid"/>
    <edittype type="0" name="archive"/>
    <edittype type="0" name="archive_da"/>
    <edittype type="0" name="area"/>
    <edittype type="0" name="bezeichung"/>
    <edittype type="0" name="fm_id"/>
    <edittype type="0" name="gid"/>
    <edittype type="0" name="new_date"/>
    <edittype type="0" name="nr_id"/>
