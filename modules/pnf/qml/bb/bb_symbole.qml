...
<qgis version="1.9.0-Master" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="art" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="25" label="Fliessrichtung"/>
      <category symbol="1" value="24" label="stehendes Gewässer"/>
      <category symbol="2" value="26" label="Schilfgürtel"/>
    </categories>
    <symbols>
      <symbol outputUnit="MM" alpha="1" type="marker" name="0">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="name" v="/usr/local/qgis-15.03/share/qgis/python/plugins/veriso/modules/pnf/symbole//symbol_a_fliessrichtung.svg"/>
          <prop k="offset" v="0,0"/>
      ...
      <symbol outputUnit="MM" alpha="1" type="marker" name="1">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#00aaff"/>
          <prop k="name" v="/usr/local/qgis-15.03/share/qgis/python/plugins/veriso/modules/pnf/symbole/symbol_e_wasserbecken_stehendes_gewaesser_param.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="7"/>
      ...
      <symbol outputUnit="MM" alpha="1" type="marker" name="2">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#00aaff"/>
          <prop k="name" v="/usr/local/qgis-15.03/share/qgis/python/plugins/veriso/modules/pnf/symbole/symbol_c_schilfguertel_param.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="6"/>
