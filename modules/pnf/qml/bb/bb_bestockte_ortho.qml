...
<qgis version="1.9.0-Master" minimumScale="-4.65661e-10" maximumScale="20000" hasScaleBasedVisibilityFlag="1">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter=" &quot;art&quot;  = 27" symbol="0" label="geschlossener_Wald"/>
      <rule filter=" &quot;art&quot;  = 30" symbol="1" label="Parkanlage_bestockt"/>
      <rule filter=" &quot;art&quot;  = 31" symbol="2" label="Hecke"/>
      <rule filter=" &quot;art&quot; = 32" symbol="3" label="uebrige_bestockte"/>
      <rule scalemaxdenom="5000" filter=" &quot;art&quot;  NOT IN (27,30,31,32)" symbol="4" label="andere"/>
    </rules>
    <symbols>
      <symbol outputUnit="MM" alpha="0.592157" type="fill" name="0">
        <layer pass="1" class="SimpleFill" locked="0">
          <prop k="color" v="0,255,255,255"/>
          <prop k="color_border" v="195,250,13,255"/>
          <prop k="offset" v="0,0"/>
          <prop k="style" v="no"/>
      ...
      <symbol outputUnit="MM" alpha="0.647059" type="fill" name="1">
        <layer pass="1" class="SimpleFill" locked="0">
          <prop k="color" v="0,0,255,255"/>
          <prop k="color_border" v="221,67,248,255"/>
          <prop k="offset" v="0,0"/>
          <prop k="style" v="no"/>
          <prop k="style_border" v="solid"/>
          <prop k="width_border" v="0.4"/>
      ...
      <symbol outputUnit="MM" alpha="1" type="fill" name="3">
        <layer pass="1" class="SimpleFill" locked="0">
          <prop k="color" v="221,93,172,255"/>
          <prop k="color_border" v="243,113,69,255"/>
          <prop k="offset" v="0,0"/>
          <prop k="style" v="no"/>
          <prop k="style_border" v="solid"/>
      ...
      <symbol outputUnit="MM" alpha="0.341176" type="fill" name="4">
