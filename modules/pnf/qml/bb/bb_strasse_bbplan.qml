...
<qgis version="1.9.0-Master" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="art" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="1" label="Strasse, Weg"/>
      <category symbol="1" value="2" label="Trottoir"/>
      <category symbol="2" value="3" label="Verkehrsinsel"/>
      <category symbol="3" value="12" label="übrige Befestigte"/>
      <category symbol="4" value="23" label="übrige Humusierte"/>
      <category symbol="5" value="" label="andere"/>
    </categories>
    <symbols>
      <symbol outputUnit="MM" alpha="0.592157" type="fill" name="0">
      ...
      <symbol outputUnit="MM" alpha="0.631373" type="fill" name="1">
        <layer pass="0" class="SimpleFill" locked="0">
      ...
      <symbol outputUnit="MM" alpha="0.639216" type="fill" name="3">
      ...
      <symbol outputUnit="MM" alpha="0.666667" type="fill" name="4">
        <layer pass="0" class="SimpleFill" locked="0">
      ...
      <symbol outputUnit="MM" alpha="0.313725" type="fill" name="5">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="color" v="86,189,182,255"/>
          <prop k="color_border" v="141,141,141,255"/>
          <prop k="offset" v="0,0"/>
          <prop k="style" v="no"/>
          <prop k="style_border" v="solid"/>
          <prop k="width_border" v="0.26"/>
    ...
    <source-symbol>
      <symbol outputUnit="MM" alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="color" v="210,175,234,255"/>
          <prop k="color_border" v="0,0,0,255"/>
          <prop k="offset" v="0,0"/>
          <prop k="style" v="solid"/>
          <prop k="style_border" v="solid"/>
